...
def build_terminal():
    ...
    sections = [
        ("----------------------------------------------------", "#30363d", 122),
        ("Name:    Anas Raza",                                  "#e6edf3", 140),
        ("Role:    Full Stack Developer",                       "#00ffcc", 158),
        ("Stack:   PHP MySQL React.js WordPress Tailwind",      "#8b949e", 176),
        ("Backend  Architecture  Cloud  Security",              "#8b949e", 194),
        ("Company: Bissbay Solutions",                          "#8b949e", 212),
        ("Degree:  MCA Scholar @ COER University",              "#febc2e", 230),
        ("Focus:   Building scalable ERP & web apps",           "#39d353", 248),
        ("----------------------------------------------------", "#30363d", 266),
    ]
